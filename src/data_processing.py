...
class DataProcessing:
    ...
    def preprocess_data(self):
        try:
            ...
            logger.error(f"Error while preprocess the data {e}")
    ...
    def feature_selection(self):
        try:
            ...
            raise CustomException("Failed to feature selection the data")
    ...
    def split_and_scale_data(self):
        try:
            ...
            logger.info("Splitting and Scaling the data....")
            return X_train,X_test,y_train,y_test
        
        except Exception as e:
            logger.error(f"Error while splitting the data {e}")
            raise CustomException("Failed to splitting the data")
